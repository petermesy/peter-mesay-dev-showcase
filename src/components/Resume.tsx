...
const Resume = () => {
  const handleDownload = () => {
    ...
    link.href = '/peter-mesay-resume.pdf'; // You'll need to add the actual PDF to public folder
    link.download = 'Peter-Mesay-Resume.pdf';
          ...
          <Card className="bg-card/50 border-border/50 hover:bg-card/70 hover:shadow-card transition-all duration-300 animate-fade-in-up">
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                <div className="mx-auto w-20 h-20 bg-gradient-primary rounded-2xl flex items-center justify-center animate-float">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm text-muted-foreground">
                  ...
                  <div>
                    <span className="font-semibold text-foreground">Education:</span> Computer Science
                  </div>
                  <div>
