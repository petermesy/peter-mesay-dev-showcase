...
const Projects = () => {
  const projects = [
    {
      title: "Academic Q&A Application",
    ...
    {
      title: "SMiS Student Management System",
      description: "Comprehensive student management platform for academic institutions, featuring enrollment, grading, attendance tracking, and reporting modules.",
      technologies: ["React", "Node.js", "Postgrs", "REST APIs"],
      category: "Full Stack"
    }
  ];
